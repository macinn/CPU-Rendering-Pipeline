...
namespace CPU_Rendering
{
    public partial class Window : Form
    {
        ...
        public Window()
        {
            ...
            renderer.addMesh(new Cube(1, new Vector3(1, 0, 0)));

            Cube c2 = new Cube(2, new Vector3(0.2f, 0.6f, 0.1f));
            c2.ModelMatrix = Matrix4x4.CreateTranslation(3, 3, 0);
            renderer.addMesh(c2);

            Cube c3 = new Cube(1, new Vector3(0.8f, 0.1f, 0.4f));
            c3.ModelMatrix = Matrix4x4.CreateTranslation(-5, -1, 1);
            renderer.addMesh(c3);

            Sphere s1 = new Sphere(3f, 10, 6, new Vector3(0.67f, 0.85f, 0.9f));
            s1.ModelMatrix = Matrix4x4.CreateTranslation(0, -6, 0);
            renderer.addMesh(s1);

            Sphere s2 = new Sphere(1f, 10, 6, new Vector3(1f, 0f, 0f));
